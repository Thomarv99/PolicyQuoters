      ...
      <main className="mx-auto max-w-4xl px-4 py-10 sm:px-6">
        <section className="rounded-3xl border border-border bg-card/86 p-6 sm:p-8">
          ...
          <div className="prose prose-sm mt-8 max-w-none text-foreground prose-headings:font-semibold prose-headings:tracking-[-0.02em] prose-h2:text-xl prose-h2:mt-8 prose-h3:text-base prose-h3:mt-6 prose-p:leading-7 prose-p:text-muted-foreground prose-li:text-muted-foreground prose-strong:text-foreground">
            ...
            <p>We may also use contact-enrichment providers to append additional contact information &mdash; such as a mailing address, an additional phone number (including a mobile number), an email address, or basic demographic details &mdash; to a contact we have identified, so that a licensed broker can reach you about insurance products and complete a quote or application. We use enrichment for marketing and follow-up about insurance, and we do not guarantee that appended details are complete or accurate. You can ask us to stop using enrichment for you or to delete the information as described in the &ldquo;Your Choices&rdquo; and &ldquo;State Privacy Rights&rdquo; sections.</p>
            <p>When one of these tools identifies a visitor, it may send the resulting contact details (such as name, email address, phone number, the page you viewed, and basic campaign and device information) to our own systems through a secure, authenticated connection, where we store them so a licensed broker can follow up with you. We protect this information the same way we protect other contact information you provide, and you can ask us to stop using it or to delete it as described in the &ldquo;Your Choices&rdquo; and &ldquo;State Privacy Rights&rdquo; sections.</p>
